	...
	<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form">
		...
		<?php endif; ?>
			<div class="logout-button">
				<input type="submit" name="Submit" class="btn btn-default button" value="<?php echo JText::_('JLOGOUT'); ?>" />
...
<?php else : ?>
	<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form" >
		...
		<input type="submit" name="Submit" class="btn btn-default button" value="<?php echo JText::_('JLOGIN') ?>" />
		<input type="hidden" name="option" value="com_users" />
