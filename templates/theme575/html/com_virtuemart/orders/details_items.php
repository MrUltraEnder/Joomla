...
<table width="<?php echo $widthTable ?>%" cellspacing="0" cellpadding="0" border="0" class="table">
	<thead align="left" class="sectiontableheader">
		...
		<th align="center" width="15%"><?php echo JText::_('COM_VIRTUEMART_ORDER_PRINT_PRODUCT_STATUS') ?></th>
		...
		<?php } ?>
		<th align="right" width="12%"><?php echo JText::_('COM_VIRTUEMART_ORDER_PRINT_SUBTOTAL_DISCOUNT_AMOUNT') ?></th>
		<th align="right" width="12%"><?php echo JText::_('COM_VIRTUEMART_ORDER_PRINT_TOTAL') ?></th>
	</thead>
<?php
